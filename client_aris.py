...
async def main():
    ...
    scheduler.add_job(gmail_processor.proceed_forecast, CronTrigger(hour=10, minute=52))
    ...
    scheduler.add_job(partial(gmail_processor.proceed_forecast, clearing=True), CronTrigger(hour=17, minute=54))
